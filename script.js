// Global variables to track user's path
let politicalCategory = '';
let lawfulness = '';

// Results object with titles and descriptions for all 27 permutations
const results = {
...
document.querySelectorAll('[id$="-morality"]').forEach(form => {
    form.addEventListener('submit', function (event) {
        ...
        `;
                ...
                document.getElementById('results').innerHTML = '<p>Error: Result not found for this path.</p>';
            }
        } else {
